...
argument-hint: "[design area, e.g. grade update flow]"
---
...
Every design decision traces to a requirement in [requirements.md](../../../docs/design/requirements.md) (R1-R5) and to a row in the [rubric tracker](../../../docs/protocol/process_protocol.md#rubric-tracker). Work that maps to neither is out of scope until a teammate says otherwise (CLAUDE.md rule 1). Say that plainly and stop - do not design it anyway.
...
When the assignment is genuinely silent and no doc answers it, that is a question for a teammate, not a decision to invent (CLAUDE.md rule 6). Flag it and carry it into the summary as an open item.
