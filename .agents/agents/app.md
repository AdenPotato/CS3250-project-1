...
- Rules: [app_protocol.md](../../docs/protocol/app_protocol.md). Shared conventions, git, commits: [core_protocol.md](../../docs/protocol/core_protocol.md). Style and the rules that bind every session: [AGENTS.md](../../AGENTS.md).
