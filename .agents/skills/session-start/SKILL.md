...
This is a recommendation and never an auto-start. If the request names the work, plan around that instead of proposing your own.
...
**Confirm the deliverable before any code.** Name it concretely and name what closes it. If it is unclear, or the design doc does not answer a question the work needs answered, stop and run [`/new-design`](../new-design/SKILL.md) or ask a teammate - never guess a requirement (AGENTS.md rule 6).
